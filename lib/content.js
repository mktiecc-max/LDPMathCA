...
export const DEFAULT_CONTENT = {
  ...
  hero: {
    ...
    ctaText: '⚡ Đặt Trước Ngay',
    note: 'Miễn phí vận chuyển toàn quốc. Duy nhất 200 suất đầu tiên',
  ...
  footer: {
    brandDesc: 'Thương hiệu Toán học Tiểu học với bộ tự học Sổ Tay MathCA + MathCA Online và chương trình trực tiếp CLB MathCA.',
    tagline: 'Học đúng để giỏi thật.',
    selfStudyTitle: 'Bộ tự học MathCA',
    selfStudyLinks: [
      { text: '📖 Sổ Tay MathCA', url: '/so-tay-mathca' },
      { text: '🎓 MathCA Online', url: '/mathca-online' },
      { text: 'Kích hoạt mã sách/khóa học', url: '/kich-hoat' },
      { text: 'Tất cả sản phẩm', url: '/san-pham' }
    ],
    directTitle: 'Học trực tiếp',
    directLinks: [
      { text: 'CLB Toán Bồi Dưỡng MathCA', url: '/clb-mathca' },
      { text: 'Phương pháp CPA + Apply', url: '/phuong-phap' },
      { text: 'Đăng ký tư vấn/học thử', url: '/lien-he' },
      { text: 'Góc phụ huynh', url: '/goc-phu-huynh' }
    ],
    contactTitle: 'Liên hệ',
    contacts: [
      { icon: '📍', text: 'Thông tin cơ sở được cập nhật tại trang Liên hệ.' },
      { icon: '📞', text: 'Yêu cầu MathCA gọi lại', url: '/lien-he' },
      { icon: '✉️', text: 'Email sẽ được cập nhật khi mở production.' }
    ],
    copyright: '© 2026 MathCA. Nội dung và nhận diện thương hiệu được bảo lưu.',
    legalLinks: [
      { text: 'Điều khoản', url: '/dieu-khoan' },
  ...
  form: {
    ...
    packages: [
      { id: '1', name: 'Mua lẻ 1 cuốn (Ưu đãi 25%)', old: 320000, new: 239000, qty: 1, image: 'https://rwtpwdyoxirfpposmdcg.supabase.co/storage/v1/object/public/mathcaweb/storefront/products/mca-st-15/1-cover-hero-8960b400014c.webp', features: '1 Sổ Tay Thiên Tài Toán Lớp 1–5\nTặng kèm Khóa MathCA Online (60 tháng)' },
      { id: '2', name: 'Mua 2 cuốn (Ưu đãi 30%)', old: 640000, new: 448000, qty: 2, image: 'https://rwtpwdyoxirfpposmdcg.supabase.co/storage/v1/object/public/mathcaweb/storefront/products/mca-st-15/1-cover-hero-8960b400014c.webp', features: '2 Sổ Tay Thiên Tài Toán Lớp 1–5\nTặng kèm 2 Khóa MathCA Online (60 tháng)' },
      { id: 'combo', name: 'Combo Tập Trung Học (Ưu đãi 35%)', old: 522000, new: 339000, qty: 1, image: 'https://rwtpwdyoxirfpposmdcg.supabase.co/storage/v1/object/public/mathcaweb/storefront/products/mca-st-15/1-cover-hero-8960b400014c.webp', features: 'Sổ Tay Thiên Tài Toán Lớp 1–5\nKhóa MathCA Online (60 tháng)\nBảng ToDoList MathCA\nĐồng hồ bấm giờ MathCA' }
    ]
  }
};
