...
export const DEFAULT_CONTENT = {
  ...
  specs: {
    ...
    rows: [
      ...
      { label: 'Chính sách', value: 'Kiểm tra hàng khi nhận' }
    ]
  },
  offer: {
  ...
  form: {
    ...
    packages: [
      ...
      { id: 'combo', name: 'Combo Tập Trung Học Tập (Ưu đãi 35%)', old: 522000, new: 339000, qty: 1, image: 'https://rwtpwdyoxirfpposmdcg.supabase.co/storage/v1/object/public/mathcaweb/storefront/products/mca-st-15/1-cover-hero-8960b400014c.webp', features: 'Sổ Tay Thiên Tài Toán Lớp 1–5\nKhóa MathCA Online (60 tháng)\nBảng ToDoList MathCA\nĐồng hồ bấm giờ MathCA' }
    ]
  }
};
